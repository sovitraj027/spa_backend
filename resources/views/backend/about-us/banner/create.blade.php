                    ...
                    <div class="card card-bordered">
                        <div class="card-inner-group">
                            ...
                            <div class="card-inner">
                                ...
                                <div class="nk-block">
                                   @isset($banner)
                                    <form action="{{route('admin.about-us.update',$banner->id)}}" method="POST" enctype="multipart/form-data">
                                        @method('put')
                                       @else
                                            ...
                                            <div class="col-xxl-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap " >
                                                        <input type="text" class="form-control" id="" name="title" value="{{isset($banner) ? $banner->title : ''}}" placeholder="Banner Title 1">
                                                    </div>
                                                </div>
                                            </div>
