                    ...
                    <div class="card card-bordered">
                        <div class="card-inner-group">
                            ...
                            <div class="card-inner">
                                ...
                                <div class="nk-block">
                                   @isset($section_one)
                                    <form action="{{route('admin.services.update',$section_one->id)}}" method="POST" enctype="multipart/form-data">
                                        @method('put')
                                       @else
                                        ...
                                        <div class="modal-dialog modal-sm" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body modal-body-md">
                                                    ...
                                                    <form action="{{route('admin.services.store')}}" class="mt-4" method="post">
                                                        @csrf
