                                    ...
                                    <tbody>
                                        @isset($blogs)
                                            ...
                                            <tr>
                                                <td>{{$blog->title_1}}</td>
                                                <td>
                                                    <img src="{{image_path($blog->image)}}" alt="" height="30px">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="tb-odr-btns d-none d-md-inline">
                                                        <a href="{{route('admin.blog.edit',$blog->id)}}" class="text-warning">
                                                            <i class="bi bi-pencil"></i>
                                                        </a>
                                                        <a href="{{route('admin.blog.delete',$blog->id)}}" class="text-danger">
